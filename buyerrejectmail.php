...
<!doctype html>
 <html>
  <head>
   <meta charset="utf-8">
    <title> Buyer reject project </title>
  </head>
 <body>
</body>
</html>
 ...
 <?php 
	...
	//accept the values from user form
		...
		$proid = $_REQUEST["pid"];
		$sql1 = "update bidding set status = 'reject' where projectid = '$proid' and username = '$uname'";
		...
		{			
			  ...
			  if(!empty($result) && $result->num_rows == 1)
			  {
				...
				//mail($email,"Forgot password request",$msg);
				  ...
				  $to = $email;
				  $subject = 'Reject project message';
				   // the message
				  $msg = "Dear ". $uname ." your bidding for project is rejected";
