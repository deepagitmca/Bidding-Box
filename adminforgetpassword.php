        ...
        <tr>
          <td bgcolor="#FFFFFF">
           <table width="1000" border="0" cellspacing="0" cellpadding="10">
            <tbody>
              <tr>
               <td width="286" height="58" align="center"><strong> <h3> Admin forgot password</h3> </strong></td>
                ...
                <p>&nbsp;</p>
                  <table width="400" border="0" align="center" cellpadding="10" cellspacing="0">
                    <tbody>
                      <tr>
                        <td colspan="2" bgcolor="#D27CED" style="text-align: center"><h2>Admin forgot password form</h2></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>&nbsp;</td>
                        <td><a href="adminlogin.php">Go to login</a></td>
                      </tr>
                </tbody>
              </table>
                  <p>&nbsp;</p>
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$sql = "SELECT * from adminlogin where username = '$uname'";
	...
	if(!empty($result) && $result->num_rows == 1)
	{
	  ...
	  //mail($email,"Forgot password request",$msg);
		...
		$subject = 'Forgot password request';
		 // the message
	  	$msg = "Dear Your username is ". $uname ." and password is :".$pass;
