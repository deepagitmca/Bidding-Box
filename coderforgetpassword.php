...
<!doctype html>
 <html>
  <head>
   <meta charset="utf-8">
    <title> Coder forget password  </title>
	 <style type="text/css">
        body 
        {
        ...
        <tr>
          <td bgcolor="#FFFFFF">
           <table width="1000" border="0" cellspacing="0" cellpadding="10">
            <tbody>
              <tr>
               <td width="286" height="58" align="center"><strong> <h3> Coder forgot password</h3> </strong></td>
                ...
                <p>&nbsp;</p>
                  <table width="400" border="0" align="center" cellpadding="10" cellspacing="0">
                    <tbody>
                      <tr>
                        <td colspan="2" style="text-align: center">Coder  forgot password form</td>
                      </tr>
                      <tr>
              ...
              <tr>
                <td align="center"><strong> <h3><img src="giphy.gif" width="270" height="295" alt=""/></h3> 
                  </strong></td>
              </tr>
            </tbody>
           </table>
